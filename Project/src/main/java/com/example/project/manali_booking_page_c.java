...
public class manali_booking_page_c implements Initializable
{
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            rs = stmt.executeQuery("SELECT * FROM manali_hotel");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
        while(true)
        ...
        try {
            rs = stmt.executeQuery("SELECT * FROM manali_flight");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
        ...
        try {
            rs = stmt.executeQuery("SELECT * FROM manali_car");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
