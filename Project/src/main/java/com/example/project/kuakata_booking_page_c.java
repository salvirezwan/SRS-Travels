...
public class kuakata_booking_page_c implements Initializable
{
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            rs = stmt.executeQuery("SELECT * FROM shimlahotel");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
        while(true)
        ...
        try {
            rs = stmt.executeQuery("SELECT * FROM shimla_flight");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
        ...
        try {
            rs = stmt.executeQuery("SELECT * FROM shimla_car");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
